...
COMPONENT.Title = [[Whelen Liberty (48") LRUPD]]
...
COMPONENT.StateMap = "[1] 1 2 5 6 7 8 9 10 11 12 15 16 [2] 3 4 [3] 13 [4] 14"
...
COMPONENT.Segments = {
	All = {
		...
		Sequences = {
			["ON"] = { 1 },
			["SINGLE_FLASH"] = sequence():Alternate( 4, 5, 5 ),
			["DOUBLE_FLASH"] = sequence():DoubleFlash( 4, 5 ),
			["TRIPLE_FLASH"] = sequence():TripleFlash( 4, 5 ),
		}
	},
	Takedown = {
		Frames = {
